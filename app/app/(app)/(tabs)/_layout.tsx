    ...
    <View style={{ flex: 1, backgroundColor: theme.colors.background }}>
      <Tabs
        screenOptions={{
          ...
          tabBarLabelStyle: {
            fontSize: theme.layout.tabBar.label.fontSize,
            fontFamily: theme.typography.bodyMedium.fontFamily,
            marginTop: theme.layout.tabBar.label.marginTop,
          },
          tabBarStyle: {
            height: theme.layout.tabBar.height + insets.bottom,
            paddingTop: theme.layout.tabBar.padding.top,
            paddingBottom: Math.max(insets.bottom, theme.layout.tabBar.padding.bottom),
            borderTopWidth: 1,
