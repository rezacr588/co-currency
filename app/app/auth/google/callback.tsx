...
function getCallbackParams(queryParams: Record<string, string | string[] | undefined>) {
  // On web, tokens are in the hash fragment (#token=...&refresh_token=...)
  // because the backend uses fragments to avoid leaking tokens in server logs.
  ...
  // On native (or if no hash), fall back to query params from Expo Router
  return {
