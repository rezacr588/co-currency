...
export function InlineCurrencySelect({ value, onChange, currencies }: InlineCurrencySelectProps) {
  ...
  return (
    <div className="relative" ref={containerRef}>
      ...
      {isOpen && (
        <div
          className={`absolute z-50 mt-1.5 w-72 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl shadow-xl shadow-slate-200/50 dark:shadow-slate-900/50 overflow-hidden animate-fade-in ${isRTL ? 'right-0' : 'left-0'}`}
