    ...
    <Card className="w-full">
      <CardHeader className="flex flex-row items-center justify-between gap-3 pb-2">
        ...
        <select
          ...
          className="flex-shrink-0 px-3 py-2.5 bg-slate-100 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700/50 rounded-lg text-slate-700 dark:text-slate-200 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-primary-600/30 transition-all cursor-pointer w-24 touch-target"
        >
          {currencies?.map((c) => (
