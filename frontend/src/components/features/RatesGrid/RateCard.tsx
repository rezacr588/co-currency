...
export function RateCard({ rate, baseCurrency }: RateCardProps) {
  ...
  return (
    <div className="group p-3 bg-slate-50/80 dark:bg-slate-800/40 hover:bg-white dark:hover:bg-slate-800/60 rounded-lg border border-slate-200/60 dark:border-slate-700/40 hover:border-indigo-300 dark:hover:border-indigo-500/30 transition-all duration-200">
      <div className="flex items-center gap-2">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-baseline justify-between gap-1">
            ...
            <span className="font-mono text-sm font-semibold text-indigo-600 dark:text-indigo-400 truncate">
