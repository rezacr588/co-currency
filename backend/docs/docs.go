...
const docTemplate = `{
    ...
    "paths": {
        "/badges": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "badges: []model.Badge",
                        "schema": {
                            "type": "object",
        ...
        "/badges/check": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "newly_earned: []model.UserBadge, total_earned: int",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/badges/earned": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "badges: []model.UserBadge, count: int",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/badges/progress": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "progress: []model.BadgeProgress, total_badges: int, earned_count: int",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/subscriptions": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "subscriptions: []model.Subscription",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_rezacr588_currency-converter_internal_model.CreateSubscriptionRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/github_com_rezacr588_currency-converter_internal_model.Subscription"
                        }
                    },
                    "400": {
        ...
        "/subscriptions/billing-cycles": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "billing_cycles: []string",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_rezacr588_currency-converter_internal_model.SubscriptionSummary"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
        ...
        "/subscriptions/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_rezacr588_currency-converter_internal_model.UpdateSubscriptionRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "message: subscription deleted successfully",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
    ...
    "definitions": {
        "github_com_rezacr588_currency-converter_internal_model.CreateSubscriptionRequest": {
            "type": "object",
            "properties": {
                "amount": {
                    "type": "number"
        ...
        "github_com_rezacr588_currency-converter_internal_model.Subscription": {
            "type": "object",
            "properties": {
                "amount": {
                    "type": "number"
                ...
                "category": {
                    "description": "streaming, software, gaming, fitness, utilities, etc.",
                    "type": "string"
                },
                "created_at": {
                    "type": "string"
        ...
        "github_com_rezacr588_currency-converter_internal_model.SubscriptionSummary": {
            "type": "object",
            "properties": {
                "active_count": {
                    "type": "integer"
        ...
        "github_com_rezacr588_currency-converter_internal_model.UpdateSubscriptionRequest": {
            "type": "object",
            "properties": {
                "amount": {
                    "type": "number"
    ...
    "tags": [
        ...
        {
            "description": "Recurring subscription and bill tracking",
            "name": "Subscriptions"
        },
        {
        ...
        {
            "description": "AI-powered features like transaction parsing",
            "name": "AI"
        },
        {
