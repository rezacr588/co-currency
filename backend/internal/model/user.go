...
type User struct {
	...
	CoAIFocusAreas         []string   `json:"focus_areas,omitempty"`
...
func (u *User) ToProfile() *UserProfile {
	return &UserProfile{
		...
		CoAIFocusAreas:         u.CoAIFocusAreas,
		WeeklyBriefEnabled:     u.WeeklyBriefEnabled,
		ProactiveAlertsEnabled: u.ProactiveAlertsEnabled,
