...
// assessAttentionRequired determines if user needs to be notified
...
if bill.DaysUntil <= 2 {
analysis.RequiresAttention = true
analysis.AttentionReason = "Bills due within 2 days"
return
}
}
...
analysis.RequiresAttention = true
analysis.AttentionReason = "Goal contribution opportunities available"
return
}
}
